...
class ResponseBodyRule {
    constructor(config) {
        ...
        this.severity = config.severity && (0, openapi_utilities_1.textToSev)(config.severity);
    }
    static isInstance(v) {
        return v?.type === 'response-body-rule';
    }
}
exports.ResponseBodyRule = ResponseBodyRule;
//# sourceMappingURL=response-body-rule.js.map