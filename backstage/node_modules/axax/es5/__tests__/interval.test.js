...
test("interval", function () { return __awaiter(void 0, void 0, void 0, function () {
    var iterable, result, iterable_1, iterable_1_1, item, e_1_1;
    var e_1, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                iterable = interval_1.interval(100, function (cb, delay) {
                    cb();
                });
                result = [];
                _b.label = 1;
