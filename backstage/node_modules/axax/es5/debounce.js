...
function debounce(timer) {
    return function inner(source) {
        return __asyncGenerator(this, arguments, function inner_1() {
            var sourceIterator, itemPromise, pendingTimerPromise, item, previousItem, raceResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __await(itemPromise)];
                    case 1:
                        item = _a.sent();
                        previousItem = item;
                        _a.label = 2;
                    case 2:
                        ...
                        return [4 /*yield*/, __await(Promise.race([itemPromise, pendingTimerPromise]))];
                    case 3:
                        raceResult = _a.sent();
                        if (!(raceResult && raceResult.hasOwnProperty("value") && raceResult.hasOwnProperty("done"))) return [3 /*break*/, 4];
                        // itemPromise won the race!
                        previousItem = item;
                        item = raceResult;
                        itemPromise = sourceIterator.next();
                        return [3 /*break*/, 8];
                    case 4: return [4 /*yield*/, __await(item.value)];
                    case 5: 
                    ...
                    case 9:
                        if (!pendingTimerPromise) return [3 /*break*/, 13];
                        return [4 /*yield*/, __await(pendingTimerPromise)];
                    case 10:
                        _a.sent();
                        return [4 /*yield*/, __await(previousItem.value)];
