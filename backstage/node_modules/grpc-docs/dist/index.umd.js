(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('styled-components'), require('react-syntax-highlighter/dist/cjs/styles/hljs/atom-one-dark'), require('GendocuPublicApis/sdk/ts/gendocu/common/types_pb'), require('react-copy-to-clipboard'), require('GendocuPublicApis/sdk/ts/gendocu/sdk_generator/v3/sdk_generator_pb'), require('react-syntax-highlighter'), require('GendocuPublicApis/sdk/ts/gendocu/sdk_generator/v3/api_description_service_pb_service'), require('GendocuPublicApis/sdk/ts/gendocu/sdk_generator/v3/api_description_service_pb'), require('@improbable-eng/grpc-web'), require('js-yaml'), require('minimatch'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'styled-components', 'react-syntax-highlighter/dist/cjs/styles/hljs/atom-one-dark', 'GendocuPublicApis/sdk/ts/gendocu/common/types_pb', 'react-copy-to-clipboard', 'GendocuPublicApis/sdk/ts/gendocu/sdk_generator/v3/sdk_generator_pb', 'react-syntax-highlighter', 'GendocuPublicApis/sdk/ts/gendocu/sdk_generator/v3/api_description_service_pb_service', 'GendocuPublicApis/sdk/ts/gendocu/sdk_generator/v3/api_description_service_pb', '@improbable-eng/grpc-web', 'js-yaml', 'minimatch', 'react-dom'], factory) :
  (global = global || self, factory(global.grpcDocs = {}, global.react, global.styled, global.atomOneDarkReasonable, global.types_pb, global.CopyToClipboard, global.sdk_generator_pb, global.SyntaxHighlighter, global.api_description_service_pb_service, global.api_description_service_pb, global.grpcWeb, global.yaml, global.minimatch, global.ReactDOM));
}(this, (function (exports, React, styled, atomOneDarkReasonable, types_pb, CopyToClipboard, sdk_generator_pb, SyntaxHighlighter, api_description_service_pb_service, api_description_service_pb, grpcWeb, yaml, minimatch, ReactDOM) {
  var React__default = 'default' in React ? React['default'] : React;
  styled = styled && Object.prototype.hasOwnProperty.call(styled, 'default') ? styled['default'] : styled;
  atomOneDarkReasonable = atomOneDarkReasonable && Object.prototype.hasOwnProperty.call(atomOneDarkReasonable, 'default') ? atomOneDarkReasonable['default'] : atomOneDarkReasonable;
  CopyToClipboard = CopyToClipboard && Object.prototype.hasOwnProperty.call(CopyToClipboard, 'default') ? CopyToClipboard['default'] : CopyToClipboard;
  SyntaxHighlighter = SyntaxHighlighter && Object.prototype.hasOwnProperty.call(SyntaxHighlighter, 'default') ? SyntaxHighlighter['default'] : SyntaxHighlighter;
  yaml = yaml && Object.prototype.hasOwnProperty.call(yaml, 'default') ? yaml['default'] : yaml;
  minimatch = minimatch && Object.prototype.hasOwnProperty.call(minimatch, 'default') ? minimatch['default'] : minimatch;
  ...
  var FileContent = function FileContent(props) {
    return React__default.createElement(React.Fragment, null, React__default.createElement(FileContentTitle, null, React__default.createElement(FileName, null, props.fileName), React__default.createElement(CopyButton, {
      text: props.children
  ...
  var SetupGolangSDK = function SetupGolangSDK(props) {
    ...
    return React__default.createElement(React.Fragment, null, React__default.createElement(SetupTitle, null, "Go modules (Go 1.12+)"), React__default.createElement(BashLine, null, "export GO111MODULE=on"), React__default.createElement(BashLine, null, 'GOSUMDB=off go get -u ' + repositoryUrl + '/...@' + props.sdkBranch));
  };
  ...
  var SetupJavaSDK = function SetupJavaSDK(props) {
    ...
    return React__default.createElement(React.Fragment, null, React__default.createElement(SetupTitle, null, "Maven"), React__default.createElement(BashLine, null, "mvn scm:checkout -DconnectionUrl=scm:git:" + props.repositoryUrl + " -DscmVersionType=" + props.sdkBranch + " -DcheckoutDirectory=sdk/" + props.sdkRepoName), React__default.createElement(FileContent, {
      fileName: "pom.xml"
  ...
  var SetupPythonSDK = function SetupPythonSDK(props) {
    ...
    return React__default.createElement(React.Fragment, null, React__default.createElement(SetupTitle, null, "Python 3"), React__default.createElement(BashLine, null, "pip3 install grpcio protobuf"), React__default.createElement(BashLine, null, 'git clone \\\n\t' + props.repositoryUrl + ' \\\n\t--branch ' + props.sdkBranch + '  ' + projectName), React__default.createElement(SetupSubtitle, null, "Then start with a code:"), React__default.createElement(FileContent, {
      fileName: 'main.py'
  ...
  var SetupJavascriptSDK = function SetupJavascriptSDK(props) {
    return React__default.createElement(React.Fragment, null, React__default.createElement(SetupTitle, null, "NPM"), React__default.createElement(BashLine, null, 'npm install git+' + props.repositoryUrl + '#' + props.sdkBranch), React__default.createElement(BashLine, null, "npm install @improbable-eng/grpc-web google-protobuf"), React__default.createElement(SetupTitle, null, "Yarn"), React__default.createElement(BashLine, null, 'yarn add ' + props.repositoryUrl + '#' + props.sdkBranch), React__default.createElement(BashLine, null, "yarn add @improbable-eng/grpc-web google-protobuf"));
  };

  var SetupTypescriptSDK = function SetupTypescriptSDK(props) {
    return React__default.createElement(React.Fragment, null, React__default.createElement(SetupTitle, null, "NPM"), React__default.createElement(BashLine, null, 'npm install git+' + props.repositoryUrl + '#' + props.sdkBranch), React__default.createElement(BashLine, null, "npm install @improbable-eng/grpc-web google-protobuf @types/google-protobuf"), React__default.createElement(SetupTitle, null, "Yarn"), React__default.createElement(BashLine, null, 'yarn add ' + props.repositoryUrl + '#' + props.sdkBranch), React__default.createElement(BashLine, null, 'yarn add @improbable-eng/grpc-web \\\n\tgoogle-protobuf @types/google-protobuf'));
  };

  var SetupCSharpSDK = function SetupCSharpSDK(props) {
    var projectName = props.projectName.replaceAll(' ', '');
    return React__default.createElement(React.Fragment, null, React__default.createElement(SetupTitle, null, "NuGet"), "In the project root (dir with yourproject.csproj file):", React__default.createElement(BashLine, null, 'git clone ' + props.repositoryUrl + ' \\\n\t --branch ' + props.sdkBranch + ' ../' + projectName), React__default.createElement(FileContent, {
  ...
  var SetupKotlinSDK = function SetupKotlinSDK(props) {
    ...
    return React__default.createElement(React.Fragment, null, React__default.createElement(SetupTitle, null, "Gradle"), React__default.createElement(FileContent, {
      fileName: "build.gradle"
  ...
  var SDKSetup = function SDKSetup(props) {
    switch (props.lang) {
      ...
      case types_pb.ProgrammingLanguage.PYTHON:
      ...
      case types_pb.ProgrammingLanguage.JAVASCRIPT:
        return React__default.createElement(SetupJavascriptSDK, {
          repositoryUrl: props.repositoryUrl,
          sdkBranch: props.sdkBranch
        });

      case types_pb.ProgrammingLanguage.TYPESCRIPT:
        return React__default.createElement(SetupTypescriptSDK, {
          repositoryUrl: props.repositoryUrl,
          sdkBranch: props.sdkBranch
        });

      case types_pb.ProgrammingLanguage.CSHARP:
      ...
      case types_pb.ProgrammingLanguage.KOTLIN:
      ...
      case types_pb.ProgrammingLanguage.GRPCURL:
        return React__default.createElement(SetupGrpcurl, null);

      case types_pb.ProgrammingLanguage.RUST:
  ...
  function programmingLangToString(lang) {
    switch (lang) {
      ...
      case types_pb.ProgrammingLanguage.REST_CURL:
        return 'bash';
  ...
  var Service = function Service(_ref) {
    ...
    return React__default.createElement(React.Fragment, null, React__default.createElement(TwoPaneWrapper, null, React__default.createElement(Pane, null, React__default.createElement(SectionTitle, null, toHumanReadableName(service.getShortName())), React__default.createElement(ServiceId, null, getServiceId(service)), React__default.createElement("p", null, service.getDescription())), React__default.createElement(Pane, null)));
  };
  ...
  var TypeFields = function TypeFields(props) {
    ...
    return React__default.createElement(React.Fragment, null, fl.map(function (el, key) {
      return React__default.createElement(React.Fragment, {
        key: key
  ...
  var FieldFields = function FieldFields(props) {
    var _useState = React.useState(props.maxDepth > props.depth),
        visible = _useState[0],
    ...
    return React__default.createElement(React.Fragment, null, React__default.createElement(FieldTableRow, {
      depth: props.depth,
  ...
  var OneofFields = function OneofFields(props) {
    var _useState2 = React.useState(props.maxDepth > props.depth),
        visible = _useState2[0],
        setVisible = _useState2[1];

    return React__default.createElement(React.Fragment, null, props.m.map(function (el, key) {
      var f = new sdk_generator_pb.FieldDescription();
      f.setName(el[0]);
      f.setTypeId('[oneof]');
      return React__default.createElement(React.Fragment, {
        key: key
  ...
  var FieldTableRow = function FieldTableRow(props) {
    return React__default.createElement(TrStyled, null, React__default.createElement(TdStyled, {
    ...
    }, props.unfoldable ? React__default.createElement(React.Fragment, null, "\xA0\xA0") : props.visible ? React__default.createElement(React.Fragment, null, "\u25BE\xA0") : React__default.createElement(React.Fragment, null, "\u25B8\xA0")), !!props.field.getOneOf() && React__default.createElement(FieldMarker, {
      markerType: 'oneof',
      direction: 'left'
      ...
      noItalic: true
    }, !!props.typpe && props.typpe.getIsMapType() ? 'Map' : React__default.createElement(React.Fragment, null, React__default.createElement("ins", {
      style: {
  ...
  var RequestCode = function RequestCode(_ref) {
    ...
    return React__default.createElement(React.Fragment, null, React__default.createElement(CodeSnippetTitle, null, React__default.createElement(CustomSelect, {
  ...
  var MethodSnippets = function MethodSnippets(_ref) {
    var snippets = _ref.snippets,
        ...
        selectedProgrammingLanguage = _ref.selectedProgrammingLanguage,
        selectProgrammingLanguage = _ref.selectProgrammingLanguage;
    return React__default.createElement(React.Fragment, null, React__default.createElement(RequestCode, {
    ...
    }), (snippets === null || snippets === void 0 ? void 0 : snippets.output) && React__default.createElement(React.Fragment, null, React__default.createElement(OutputSeparator, null, "Example output (decoded)"), React__default.createElement(MethodOutput, {
  ...
  var Method = function Method(_ref) {
    ...
    return React__default.createElement(MethodWrapper, null, React__default.createElement(SectionSubtitle, null, React__default.createElement("span", {
      ...
      allTypes: types
    })), React__default.createElement(Pane, null, selectedProgrammingLanguage !== types_pb.ProgrammingLanguage.PYTHON && React__default.createElement(MethodSnippets, {
      codeProvider: codeProvider,
  ...
  var getMetadata = function getMetadata(passwordSessionId) {
    var meta = new grpcWeb.grpc.Metadata();
  ...
  var GendocuCodeProvider = /*#__PURE__*/function () {
    function GendocuCodeProvider(buildId) {
      ...
      this.sdkGeneratorClient = new api_description_service_pb_service.SdkGeneratorClient(GenDocuBackendSdkBackend);
    }
    ...
    _proto.getAvailableProgrammingLanguages = function getAvailableProgrammingLanguages(langs) {
      return langs.filter(function (el) {
        return el !== types_pb.ProgrammingLanguage.PYTHON;
      });
    };
    ...
    _proto.getAllSnippets = function getAllSnippets(lang, sessionId) {
      ...
      return new Promise(function (resolve) {
        var req = new api_description_service_pb.GenerateInputCodeSnippetsRequest();
  ...
  var DefaultStyleLoginWidget = function DefaultStyleLoginWidget(props) {
    ...
    return React__default.createElement(React.Fragment, null, React__default.createElement(LoginWrapper, null, React__default.createElement(LoginBox, null, React__default.createElement("h1", null, "Password protected"), React__default.createElement("div", null, React__default.createElement(Description, null, "Enter the password."), React__default.createElement(PasswordLine, null, React__default.createElement(PasswordInput, {
      type: 'password',
  ...
  var GenDocuWidget = function GenDocuWidget(props) {
    ...
    var _useState6 = React.useState(getPreferredProgrammingLanguage()),
    ...
    var sdkGenerator = new api_description_service_pb_service.SdkGeneratorClient(GenDocuBackendSdkBackend);
    console.log("here!");
    React.useEffect(function () {
      console.log("here2!");
      var buildwithorgandname = new api_description_service_pb.BuildWithOrgAndName();
      buildwithorgandname.setApiName(props.project);
      buildwithorgandname.setOrganization(props.organization);
      var buildselectorrequest = new api_description_service_pb.BuildSelectorRequest();
      ...
      sdkGenerator.getBuild(buildselectorrequest, getMetadata(passwordSessionId), function (err, value) {
        if (!!err || !value) {
          setError(err || {
            ...
            code: -1,
            metadata: new grpcWeb.grpc.Metadata()
          });
        } else {
          setBuild(value);
    ...
    var testPassword = function testPassword(password) {
      ...
      var buildselectorrequest = new api_description_service_pb.BuildSelectorRequest();
      buildselectorrequest.setOrgAndName(buildwithorgandname);
      var req = new api_description_service_pb.EnterPasswordRequest();
    ...
    if (err) {
      if ((err === null || err === void 0 ? void 0 : err.code) === grpcWeb.grpc.Code.PermissionDenied) {
        return React__default.createElement(React.Fragment, null, React__default.createElement(DefaultStyleLoginWidget, {
  ...
  var NoBackendCodeProvider = /*#__PURE__*/function () {
    ...
    _proto.getAvailableProgrammingLanguages = function getAvailableProgrammingLanguages() {
      return [types_pb.ProgrammingLanguage.GRPCURL];
    };

    _proto.getAllSnippets = function getAllSnippets(lang) {
      var _this = this;

      if (lang !== types_pb.ProgrammingLanguage.GRPCURL) {
        console.error();
  ...
  var PseudomutoProtocGenDoc = function PseudomutoProtocGenDoc(_ref) {
    ...
    var _useState3 = React.useState(types_pb.ProgrammingLanguage.GRPCURL),
        ...
        try {
          var _temp7 = function _temp7() {
            function _temp3() {
              ...
              var data = new sdk_generator_pb.APIDescriptionGeneratorModel();
              ...
              protocDefinition.files.forEach(function (el) {
                el.services.forEach(function (service) {
                  var srvc = new sdk_generator_pb.ServiceDescription();
                  ...
                  service.methods.forEach(function (method) {
                    var m = new sdk_generator_pb.MethodDescription();
                ...
                el.messages.forEach(function (type) {
                  var typeDescription = new sdk_generator_pb.TypeDescription();
                ...
                el.enums.forEach(function (e) {
                  ...
                  var enumDescription = new sdk_generator_pb.EnumDescription();
              ...
              var build = new api_description_service_pb.Build();
              build.setData(data);
              ...
              if (apiSpec) {
                try {
                  ...
                  var res = apiSpec;
                  var env = new api_description_service_pb.Environment();
                  env.setId('default');
    ...
    return React__default.createElement(DefaultStyle, {
      codeSnippets: codeSnippets,
      build: apiBuild,
      availableProgrammingLangs: [types_pb.ProgrammingLanguage.GRPCURL],
      selectedProgrammingLang: types_pb.ProgrammingLanguage.GRPCURL,
  ...
  var GRPCGenDocuAPIReference = function GRPCGenDocuAPIReference(props) {
    return React.createElement(GenDocuWidget, Object.assign({}, props));
  };
  var GRPCSelfGeneratedAPIReference = function GRPCSelfGeneratedAPIReference(_ref) {
    var file = _ref.file,
        scheme = _ref.scheme,
        definition = _ref.definition;
    return React.createElement(PseudomutoProtocGenDoc, {
      file: file,
      scheme: scheme,
  ...
  var init = function init(config) {
    ...
    var component = config.GenDocuBackend.project !== '' ? React.createElement(GRPCGenDocuAPIReference, {
      project: config.GenDocuBackend.project,
      organization: config.GenDocuBackend.organization
    }) : React.createElement(GRPCSelfGeneratedAPIReference, {
  ...
  exports.GRPCGenDocuAPIReference = GRPCGenDocuAPIReference;
  exports.GRPCSelfGeneratedAPIReference = GRPCSelfGeneratedAPIReference;
  exports.init = init;
